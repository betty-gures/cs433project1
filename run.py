...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model",
        choices=["ordinary_least_squares", "logistic_regression", "linear_svm", "k_nearest_neighbors"],
        default="ordinary_least_squares",
        help="The model to use for training and evaluation."
    )
    parser.add_argument("--submission_file_name", type=str, default="ordinary_least_squares", help="Name of the submission file (without dir and file name).")
    parser.add_argument(
        "--verbose",
        action="store_true",
